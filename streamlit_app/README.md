...
5. **스크린샷**: 축구장 아래 📷 스크린샷 버튼 탭

### 📷 스크린샷 기능
- 선수를 1명 이상 추가하면 축구장 아래에 **📷 스크린샷** 버튼이 나타남
- 버튼을 클릭/탭하면 즉시 PNG 이미지로 다운로드됨
- 저장되는 이미지에는 "올에셋 라인업 빌더" 제목이 자동으로 포함됨
- 고해상도 (3배 스케일, 1200x1950px)로 저장되어 매우 선명함
- 파일명: `올에셋_라인업.png`
- PC와 모바일 모두에서 동일하게 작동
